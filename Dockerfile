...
RUN apt-get update \
 && apt-get install -y --no-install-recommends --no-install-suggests rocm-llvm hipblas-dev rocblas-dev hip-samples rocm-device-libs
